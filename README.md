...
「二/三/四合推薦」頁提供 **7 種統計演算法**,可即時切換比較。每種有其數學基礎、適用場景與限制。
...
**怎麼解讀**:某二合出現 15 次,只比平均 12 次多 25%,在 907 樣本下這個差距大概率是抽樣雜訊,不是真訊號。
...
- **二合**:9070 樣本 / 741 組合 = 12.2 次/組合 → 頻率類有意義,給 weighted 35%
- **三合**:9070 樣本 / 9139 組合 = 0.99 次/組合 → 半數沒出現過,提高 marginal 到 30%
- **四合**:4535 樣本 / 82,251 組合 = 0.055 次/組合 → 95% 沒出現,**marginal 必須主導 (55%)**
